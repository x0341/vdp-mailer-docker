...
issue](https://github.com/cisagov/vdp-mailer-docker/issues) in this
...
request](https://github.com/cisagov/vdp-mailer-docker/pulls), you will
...
```console
cd vdp-mailer-docker
pyenv virtualenv <python_version_to_use> vdp-mailer-docker
pyenv local vdp-mailer-docker
